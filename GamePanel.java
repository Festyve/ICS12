...
//short enum that defines all possible states/screens in the game.
    ...
    private void loadResourcesInConstructor() {
        ...
        try {
            ...
            fightBarImage = null;
            System.err.println("Failed to load fight bar image: " + ex.getMessage());
        }
        ...
        try {
            ...
            cursorImage = null;
            System.err.println("Failed to load cursor image: " + ex.getMessage());
        }
        ...
        try {
            ...
            System.err.println("Failed to load exclamation.png: " + ex.getMessage());
        }
        ...
        try {
            ...
            kirbyIcon = null;
            kirbyImage = null;
            System.err.println("Failed to load Kirby image: " + ex.getMessage());
        }
        ...
        try {
            ...
            bossImage = null;
            System.err.println("Failed to load boss image: " + ex.getMessage());
        }
        ...
        try {
            ...
            playerImage = null;
            System.err.println("Failed to load and resize player normal image: " + ex.getMessage());
        }
        ...
        try {
            ...
            flashImage = null;
            System.err.println("Failed to load and resize player flash image: " + ex.getMessage());
        }
        ...
        try {
            ...
            System.err.println("Failed to load background.jpg: " + ex.getMessage());
        }
        ...
        try {
            ...
            bulletImage = null;
            System.err.println("Failed to load and resize fireball.png: " + ex.getMessage());
        }
    ...
    private void drawItemSelect(Graphics g) {
        ...
        if (selectedItem != null) {
            ...
            drawStringWrapped(g, idesc, bottomBox.x + 40, bottomBox.y + 150, bottomBox.width - 80);
        } else {
